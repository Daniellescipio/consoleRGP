const supply = class{
    constructor(type, affectedObj, name, benefit, loss, verb, good, bad) {
        this.type = type;
        this.name = name;
...
const supplies = [
    ...
    new supply("food", false, "pig roasting over a fire","eat", 10, 10, "Finders keepers losers weepers, what a find!", "The owner caught you touching their pig and chased you away.",true),
    ...
    new supply("food", false, "beehive", 7, 9,"smoke", "You smoke out the Bees and steal their delicious honey, the boost of energy is immediate.", "YYou have no clue what you're doing. You make the bees angry and spend hours running away.",false),
    ...
    new supply("medicine",true, "", 50, 40, "tust", "The true backbones of the medical field, you feel better than you've felt in days!! Any dragons around?", "The nurse forgot to wash her hands after her last aptient, you get sick with whatever they had.",true),
]
export{supplies}